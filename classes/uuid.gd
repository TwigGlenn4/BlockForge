# Attribution: Orignal UUID class by binogure, under MIT License: Copyright (c) 2023 Xavier Sellier
# https://godotengine.org/asset-library/asset/81
# https://github.com/binogure-studio/godot-uuid

# This file has been edited for this project, notable changes include
# rename as_string() to _to_string()
